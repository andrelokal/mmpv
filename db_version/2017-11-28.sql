...
-- Dumping data for table mm.fisica: ~3 rows (approximately)
...
INSERT INTO `fisica` (`id`, `pessoa_id`, `nome`, `telefone`, `cpf`, `CEP`, `numero`, `endereco`, `complemento`, `observacao`, `rg`, `dt_nascimento`, `sexo`, `tem_conta`, `dia_mes_pagto`, `limite_conta`, `dt_cadastro`) VALUES
	(1, 133, 'Ulisses', '(12) 32323-2323', '301.625.408-50', '08485050', '12', 'Rua Estrelizia, Conjunto Habitacional Santa Etelvina II, São Paulo, SP', NULL, NULL, NULL, NULL, NULL, 'y', NULL, 20.00, '2017-11-28 08:20:40'),
	(2, 134, 'Fulano', '(11) 11111-1111', NULL, '08485060', '11', 'Rua Pau Formiga, Conjunto Habitacional Santa Etelvina II, São Paulo, SP', NULL, NULL, NULL, NULL, NULL, 'y', NULL, NULL, '2017-11-28 08:20:40'),
...
-- Dumping data for table mm.itens_venda: ~13 rows (approximately)
...
-- Dumping data for table mm.pessoa: ~53 rows (approximately)
...
-- Dumping data for table mm.produto: ~3 rows (approximately)
...
INSERT INTO `produto` (`id`, `codigo`, `codbar`, `categoria_id`, `nome`, `descricao`, `valor`, `unidade_id`, `estoque_min`, `estoque`, `tem_estoque`, `active`) VALUES
	(2, '001', NULL, 2, 'Teste', NULL, 10.00, 1, 5, -151, 'n', 'y'),
	(3, '002', NULL, 2, 'Produto', NULL, 23.23, 1, 0, -117, 'n', 'y'),
...
-- Dumping data for table mm.venda: ~12 rows (approximately)
...
-- Dumping data for table mm.venda_pagto: ~12 rows (approximately)
