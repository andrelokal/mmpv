...
-- Dumping data for table mm.config: ~1 rows (approximately)
...
-- Dumping data for table mm.itens_venda: ~19 rows (approximately)
...
-- Dumping data for table mm.pessoa: ~55 rows (approximately)
...
INSERT INTO `produto` (`id`, `codigo`, `codbar`, `categoria_id`, `nome`, `descricao`, `valor`, `unidade_id`, `estoque_min`, `estoque`, `tem_estoque`, `active`) VALUES
	(2, '001', NULL, 2, 'Teste', NULL, 10.00, 1, 5, -157, 'n', 'y'),
	(3, '002', NULL, 2, 'Produto', NULL, 23.23, 1, 0, -119, 'n', 'y'),
	(4, '003', NULL, 2, 'Produto 3', NULL, 54.53, 1, 0, -50, 'n', 'y'),
	(5, 'P01', NULL, 4, 'Pizza Mussarela', NULL, 35.00, 4, 0, 0, 'n', 'y');
...
-- Dumping data for table mm.venda: ~17 rows (approximately)
...
-- Dumping data for table mm.venda_pagto: ~17 rows (approximately)
