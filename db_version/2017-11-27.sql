...
-- Copiando dados para a tabela mm_bd.caixa: ~1 rows (aproximadamente)
...
-- Copiando dados para a tabela mm_bd.comanda_mesa: ~2 rows (aproximadamente)
...
INSERT INTO `comanda_mesa` (`id`, `codigo`, `active`, `status`, `dt_status_O`, `dt_status_L`, `venda_id`) VALUES
	(3, '01', 'y', 'O', '2017-11-27 21:54:27', NULL, 110),
	(4, '02', 'y', 'L', '2017-11-27 21:53:58', NULL, NULL);
...
INSERT INTO `fisica` (`id`, `pessoa_id`, `nome`, `telefone`, `cpf`, `CEP`, `numero`, `endereco`, `observacao`, `rg`, `dt_nascimento`, `sexo`, `tem_conta`, `dia_mes_pagto`, `limite_conta`) VALUES
	(1, 133, 'Ulisses', '(12) 32323-2323', '301.625.408-50', '08485050', '12', 'Rua Estrelizia, Conjunto Habitacional Santa Etelvina II, São Paulo, SP', NULL, NULL, NULL, NULL, 'y', NULL, 20.00),
	(2, 134, 'Fulano', '(11) 11111-1111', NULL, '08485060', '11', 'Rua Pau Formiga, Conjunto Habitacional Santa Etelvina II, São Paulo, SP', NULL, NULL, NULL, NULL, 'y', NULL, NULL),
	(3, 135, 'Fulano', '(11) 11111-1111', NULL, '08485060', '11', 'Rua Pau Formiga, Conjunto Habitacional Santa Etelvina II, São Paulo, SP', NULL, NULL, NULL, NULL, 'y', NULL, NULL),
	(4, 136, 'Fulano', '(11) 11111-1111', NULL, '08485060', '11', 'Rua Pau Formiga, Conjunto Habitacional Santa Etelvina II, São Paulo, SP', NULL, NULL, NULL, NULL, 'y', NULL, NULL),
	(5, 137, 'Fulano', '(11) 11111-1111', NULL, '08485060', '11', 'Rua Pau Formiga, Conjunto Habitacional Santa Etelvina II, São Paulo, SP', NULL, NULL, NULL, NULL, 'y', NULL, NULL),
	(6, 138, 'Teste', '(23) 23332-3232', NULL, '23123423', '12', 'sdfsdfsd', NULL, NULL, NULL, NULL, 'y', NULL, NULL);
...
-- Copiando dados para a tabela mm_bd.funcionario: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `funcionario` DISABLE KEYS */;
INSERT INTO `funcionario` (`id`, `nome`, `tipo_us`, `pessoa_id`, `login`, `senha`, `token_change_password`, `delivery`) VALUES
	(1, 'Administrador', 'M', 1, 'adm', '4297f44b13955235245b2497399d7a93', '', 'N');
...
-- Copiando dados para a tabela mm_bd.itens_venda: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela mm_bd.pessoa: ~50 rows (aproximadamente)
...
-- Copiando dados para a tabela mm_bd.produto: ~2 rows (aproximadamente)
...
INSERT INTO `produto` (`id`, `codigo`, `codbar`, `categoria_id`, `nome`, `descricao`, `valor`, `unidade_id`, `estoque_min`, `estoque`, `tem_estoque`, `active`) VALUES
	(2, '001', NULL, 2, 'Teste', NULL, 10.00, 1, 5, -141, 'n', 'y'),
	(3, '002', NULL, 2, 'Produto', NULL, 23.23, 1, 0, -114, 'n', 'y'),
...
-- Copiando dados para a tabela mm_bd.venda: ~11 rows (aproximadamente)
...
INSERT INTO `venda` (`id`, `cliente_id`, `desconto`, `total`, `data`, `status`, `comanda_mesa_id`, `caixa_id`) VALUES
	...
	(110, NULL, 0.00, NULL, '2017-11-27 21:54:27', 'A', 3, 33);
...
-- Copiando dados para a tabela mm_bd.venda_pagto: ~0 rows (aproximadamente)
