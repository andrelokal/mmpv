...
-- Copiando dados para a tabela mm_bd.categoria: ~3 rows (aproximadamente)
...
-- Copiando dados para a tabela mm_bd.entrada_produto: ~2 rows (aproximadamente)
...
-- Copiando dados para a tabela mm_bd.fisica: ~5 rows (aproximadamente)
...
-- Copiando dados para a tabela mm_bd.fisica_conta: ~5 rows (aproximadamente)
...
-- Copiando dados para a tabela mm_bd.itens_venda: ~21 rows (aproximadamente)
...
-- Copiando dados para a tabela mm_bd.module: ~13 rows (aproximadamente)
/*!40000 ALTER TABLE `module` DISABLE KEYS */;
INSERT INTO `module` (`module_id`, `text`, `parent`, `active`, `link`, `order`, `icon`) VALUES
	(1, 'Cadastro', NULL, 'Y', '', 1, 'fa-keyboard-o'),
	(2, 'Categoria', 23, 'Y', 'internals/category', 3.1, 'fa-sitemap'),
	(6, 'Produtos', NULL, 'Y', 'internals/product', 0.1, ' fa-gift'),
	(13, 'Fornecedores', 1, 'Y', 'internals/company', 1.3, 'fa-truck'),
	(14, 'Funcionários', 1, 'Y', 'internals/employee', 1.4, 'fa-address-card-o'),
	(15, 'Clientes', 1, 'Y', 'internals/buyer', 1.5, 'fa-users'),
	(16, 'Unidades', 23, 'Y', 'internals/measure', 3.2, 'fa-eyedropper'),
	(17, 'Formas de Pagamento', 23, 'Y', 'internals/payment', 3.3, 'fa-money'),
	(18, 'Controle de Estoque', NULL, 'Y', 'internals/stock', 0.2, 'fa-cubes'),
	(19, 'Relatórios', NULL, 'Y', NULL, 2, 'fa-bar-chart'),
	(20, 'Vendas', 19, 'Y', 'rel/sale', 2.1, 'fa-shopping-basket'),
	(21, 'Configurações', NULL, 'Y', 'internals/profile', 4, 'fa-sliders'),
	(22, 'Mesas', 23, 'Y', 'grid/tables', 3.4, 'fa-bell-o'),
	(23, 'Manutenção', NULL, 'Y', NULL, 3, 'fa-wrench'),
	(24, 'Delivery', 19, 'Y', 'rel/delivery', 2.2, 'fa-motorcycle');
...
-- Copiando dados para a tabela mm_bd.pessoa: ~55 rows (aproximadamente)
...
-- Copiando dados para a tabela mm_bd.venda: ~18 rows (aproximadamente)
/*!40000 ALTER TABLE `venda` DISABLE KEYS */;
INSERT INTO `venda` (`id`, `cliente_id`, `desconto`, `total`, `data`, `status`, `comanda_mesa_id`, `caixa_id`) VALUES
	(106, NULL, 0.00, 20.00, '2017-11-27 21:51:34', 'A', 3, 33),
	(107, NULL, 0.00, 23.23, '2017-11-27 21:53:15', 'A', 3, 33),
	(108, NULL, 0.00, 54.53, '2017-11-27 21:53:23', 'A', 4, 33),
	(109, NULL, 0.00, 20.00, '2017-11-27 21:53:40', 'A', 4, 33),
	(110, NULL, 0.00, 23.23, '2017-11-27 21:54:27', 'A', 3, 33),
	(111, NULL, 0.00, 10.00, '2017-11-28 07:54:19', 'F', NULL, 33),
	(112, NULL, 0.00, 10.00, '2017-11-28 08:18:51', 'F', NULL, 33),
	(113, NULL, 0.00, 10.00, '2017-11-28 08:23:33', 'F', NULL, 33),
	(114, NULL, 0.00, 23.23, '2017-11-28 08:26:06', 'A', 3, 33),
	(115, NULL, 0.00, 10.00, '2017-11-28 08:30:50', 'A', 3, 33),
	(116, NULL, 0.00, 10.00, '2017-11-28 09:16:44', 'F', NULL, 33),
	(117, NULL, 0.00, 10.00, '2017-11-28 09:18:27', 'F', NULL, 33),
	(118, NULL, 0.00, 10.00, '2017-11-29 07:54:55', 'F', NULL, 33),
	(119, NULL, 0.00, 10.00, '2017-11-29 07:55:03', 'F', NULL, 33),
	(120, NULL, 0.00, 10.00, '2017-11-29 07:56:14', 'F', NULL, 33),
	(121, NULL, 0.00, 33.23, '2017-11-29 07:56:54', 'A', 4, 33),
	(122, NULL, 0.00, 10.00, '2017-11-29 09:29:55', 'F', NULL, 33),
	(188, NULL, 0.00, 35.00, '2017-11-29 18:53:25', 'F', NULL, 33),
	(189, NULL, 0.00, 10.00, '2017-11-29 22:29:04', 'F', NULL, 33);
...
-- Copiando dados para a tabela mm_bd.venda_pagto: ~18 rows (aproximadamente)
