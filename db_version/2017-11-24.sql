...
-- Copiando dados para a tabela mm_bd.fisica: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela mm_bd.itens_venda: ~2 rows (aproximadamente)
...
INSERT INTO `itens_venda` (`id`, `venda_id`, `produto_id`, `quantidade`, `valor_unitario`, `status`, `nome_cliente`) VALUES
	...
	(81, 91, 2, 1.00, 10.00, 'E', NULL),
	(82, 92, 3, 1.00, 23.23, 'E', NULL),
	(83, 92, 4, 3.00, 54.53, 'E', NULL);
...
-- Copiando dados para a tabela mm_bd.produto: ~3 rows (aproximadamente)
...
INSERT INTO `produto` (`id`, `codigo`, `codbar`, `categoria_id`, `nome`, `descricao`, `valor`, `unidade_id`, `estoque_min`, `estoque`, `tem_estoque`, `active`) VALUES
	(2, '001', NULL, 2, 'Teste', NULL, 10.00, 1, 5, -80, 'n', 'y'),
	(3, '002', NULL, 2, 'Produto', NULL, 23.23, 1, 0, -86, 'n', 'y'),
	(4, '003', NULL, 2, 'Produto 3', NULL, 54.53, 1, 0, -46, 'n', 'y');
...
-- Copiando dados para a tabela mm_bd.venda: ~2 rows (aproximadamente)
